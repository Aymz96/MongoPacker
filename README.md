# Mongodb Packer :computer: :cd:

This repository contains files which will be working in conjunctions with the MongoCookbookStarterCode. These will be used to create an Amazon Machine Image (AMI) in AWS. It will consist of npm, pm2, nginx and nodejs.
...
Clone and navigate into the MongoPacker directory and follow the steps below.

- Run berkshelf to pull the latest Mongodb cookbook.
```bash
$ berks vendor
```
